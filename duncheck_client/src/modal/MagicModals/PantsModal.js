            ...
            {open ? (
                <MagicCutBox>
                    <MagicInput>
                        ...
                        <MagicCutValue type = 'number' onChange = {onHandlerPants} value = {pants}/>
                        <SettingMagicButton className = 'settingPants' onClick = {() => {onSubmitPants(); close();}}>닫기</SettingMagicButton>
                    </MagicInput>
                </MagicCutBox>
            ): null}
        </div>
